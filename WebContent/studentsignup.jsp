...
<center><h2>Student Sign Up</h2></center>
 <form action="StudentSignupServlet" id="ContactUsCaptchaWebForm" method="post" onsubmit="return validateForm(this);">
 ...
 <td><b>Gender:</b></td>
 <td><input id="gender" name="gender" type="radio" value="Male"/>Male &nbsp; <input id="gender1" name="gender1" type="radio" value="Female" />Female</td>
 </tr><tr>
