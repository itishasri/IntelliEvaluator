...
<%
StudentSignupBean tvb= (StudentSignupBean)session.getAttribute("tvb1");
System.out.println(tvb.getRollno());
System.out.println(tvb.getImage());
%>
<h1><font color=white><u color=white>Personal Information</u></font></h1>
<img class="img-circle" src="<%=tvb.getImage() %>" alt="profile" />
<br><br><br>

<table cellpadding=4  class="table">
<tr><td><font color=white><b>Roll Number</b></font></td><td><font color=white><b>:</b></font></td><td><font color=white><b><%=tvb.getRollno() %></b></font></td></tr>
...
<tr><td><font color=white><b>Date of Birth</b></font></td><td><font color=white><b> : </b></font></td><td><font color=white><b><%=tvb.getDob() %></b></font></td></tr>
</table>
</form>
</center>
</body>
