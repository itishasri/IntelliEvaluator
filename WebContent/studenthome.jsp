...
%>
 ...
 <center>  
    ...
    <tr>
    <td>
    <button class="button1" onclick="location.href='TopicListServlet'">Take New Test</button>
    </td>
    </td>
    <td>
    </td>
...
<ellipse fill="#EF3D23" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
    ...
    <td>
    <button class="button1" onclick="location.href='StudentScoreTopicList'">Get Score</button>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td>
    <button class="button1" onclick="location.href='editprofilestudent.jsp'">Edit Details </button>
     </td>
    <td>
    </td>
    <td>
    ...
    <td>
     <button class="button1" onclick="location.href='ViewProfileStudentServlet'">View Profile </button>
   	</td>
    </tr>
    </table>
  </center>
